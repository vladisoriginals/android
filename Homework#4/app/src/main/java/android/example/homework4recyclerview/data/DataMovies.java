...
import android.example.homework4recyclerview.R;
...
public class DataMovies {
    public static List<Movie> getMovieList(){
        ...
        movieList.add(new Movie("Jurassic World - Fallen Kingdom",
        ...
        movieList.add(new Movie("Ocean's Eight",
        ...
        movieList.add(new Movie("Guardians of the Galaxy",
