...
class MoviesRepositoryImpl(private val databaseMovies: MoviesDatabase, private val moviesApiService: MoviesApiService) : MoviesRepository {
    ...
    override fun getTrailerFromNetwork(movie: Movie): Completable {
