...
public static List<Movies>getMovieList(){
    ...
    movieList.add(new Movies("Jurassic World - Fallen Kingdom",
    ...
    movieList.add(new Movies("Ocean's Eight",
    ...
    movieList.add(new Movies("Guardians of the Galaxy",
